...
const CategoryManage = () => {
  ...
  const handleDeleteCategory = async (docId) => {
    ...
    // console.log("🚀 ~ file: CategoryManage.js ~ line 32 ~ handleDeleteCategory ~ docData", docData.data())
  };
  ...
  return (
    <div>
      <DashboardHeading title="Categories" desc="Manage your category">
        <Button kind="ghost" height="60px" to="add">
          Create category
        </Button>
      </DashboardHeading>
              ...
              <tr key={category.id}>
                ...
                <td>
                  <div className="flex items-center gap-x-3 ">
                    ...
                    <ActionEdit
                      onClick={() =>
                        navigate(`/dashboard/category/update?id=${category.id}`)
                      }
                    ></ActionEdit>
                    <ActionDelete
